...
runtime_app::TelemetryTickInput tick(std::uint64_t tick_id, bool aiming = true) {
    ...
    value.enemy_mark_request_pending = true;
    value.enemy_mark_synthetic_pressed = true;
    value.enemy_mark_fired = true;
    value.enemy_mark_confirmation_frames = 2;
    value.enemy_mark_target_scope = 7;
    value.enemy_mark_target_generation = 91;
    value.enemy_mark_last_scope = 7;
    value.enemy_mark_last_generation = 91;
    ...
    value.visual_authority = 0.83f;
    value.enemy_cue_current = true;
    value.enemy_identity_confirmed = true;
    value.enemy_cue_checked = true;
