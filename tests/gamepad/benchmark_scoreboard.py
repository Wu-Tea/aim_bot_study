...
def _history_metric_names(history_runs: Sequence[ScoreboardRunEntry]) -> list[str]:
    preferred_order = [
        ...
        "wrong_input_recovery_coverage_ratio",
        "manual_yield_score",
...
def _history_column_title(metric_name: str) -> str:
    titles = {
        ...
        "turn_recovery_coverage_ratio": "Turn Recovery Coverage Delta",
        "decel_settle_coverage_ratio": "Decel Settle Coverage Delta",
        "conflict_frames_ratio": "Conflict Delta",
        "wrong_input_recovery_frames": "Wrong Input Recovery Delta",
        "wrong_input_recovery_coverage_ratio": "Wrong Input Recovery Coverage Delta",
