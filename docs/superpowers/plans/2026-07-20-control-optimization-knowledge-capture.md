...
- [ ] **Step 1: Write the causal timeline**
...
- [ ] **Step 2: Record rejected interpretations**
...
- [ ] **Step 1: Define the optimization loop**
...
- [ ] **Step 2: Define benchmark and metric rules**
...
- [ ] **Step 3: Define architecture and complexity rules**
...
- [ ] **Step 4: Add a skill-ready package proposal**
...
- [ ] **Step 1: Archive existing context verbatim**
...
- [ ] **Step 2: Rewrite the primary session log**
...
- [ ] **Step 4: Verify preservation and context quality**
...
- [ ] **Step 2: Cross-check repository state**
