...
echo Vision settings: backend=%VISION_BACKEND% capture_fps=%VISION_CAPTURE_FPS% track_fps=%VISION_TRACK_FPS% warm_scan_fps=%VISION_WARMSCAN_FPS% scan_fps=%VISION_SCAN_FPS% recovery_scan_fps=%VISION_RECOVERY_SCAN_FPS% quit_key=%VISION_QUIT_KEY% debug=on
